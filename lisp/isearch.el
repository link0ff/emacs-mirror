...
(defvar isearch-mode-map
  (let ((i 0)
    ...
    (define-key map [switch-frame] 'isearch-switch-frame)
    (define-key map [delete-frame] 'isearch-delete-frame)
...
(defun isearch-switch-frame (&rest ignore)
  (interactive)
  (message "!!! switch-frame %S" ignore))

(defun isearch-delete-frame (&rest ignore)
  (interactive)
  (message "!!! delete-frame %S" ignore))
